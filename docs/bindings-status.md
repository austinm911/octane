...
Initial Mapbox GL JS 3.5+ and MapLibre GL JS 4+ entry points with an authored Octane component layer; parity verification and browser/WebGL coverage remain in progress.
